        ...
        <div class="data-col">
          <div class="profile-nav-panel">
            ...
            <ul class="prof-links">
              ...
              <li class="prof-lists">
                <a href="" class="prof-link">My Orders</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div class="row">
              <div class="data-col">
                <div class="display-info-panel">
                  <form action="{{ route('profile.update',auth()->user()->email) }}" method="post" class="form-action">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="input-holder">
                      <label for="" class="input-label">Residence</label>
                      <input
                    ...
                    <div class="input-holder">
                      <label for="" class="input-label">Country</label>
                      <select name="country" id="" class="input-space">
                    ...
                    <div class="input-holder">
                      <label for="" class="input-label">Postal Code</label>
                      <input
                    ...
                    <div class="prof-btn-options" style="margin: 2em 0">
                        <button class="prof-edit-info" style="border:none;font-size: 16px;cursor: pointer;">Update</button>
                    </div>
                  </form>
                </div>
              </div>
